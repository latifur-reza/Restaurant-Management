...
@section('content')
  ...
  <div class="container-fluid ">
    <h1 class="text-center" style="color: black">Daily Expenses List Archive</h1>
  </div>
            ...
            <td>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" style="color: red">
                      {{$item->categoryname}} Amount {{$item->amount}} will be Deleted Premanently. Are you sure?
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                      <form class="" action="{!! route('dailyexpensesdestroy',$item->id) !!}" method="post" enctype="multipart/form-data">
                        @csrf
              ...
              <div class="modal fade" id="active{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Active Expenses</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body" style="color: green">
                      {{$item->categoryname}} Amount {{$item->amount}} will be Shown in list. Are you sure?
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                      <form class="" action="{!! route('dailyexpensesactive',$item->id) !!}" method="post" enctype="multipart/form-data">
                        @csrf
