    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8">
            <form class="form-group" action="{!! route('newreservation.store') !!}" method="post">
                @csrf
                <div class="row">
                        ...
                        <ol class="list-group text-center" style="list-style: none">
                          ...
                          <li class="list-group-item list-group-item-success">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    Reserved At :
                                    <input type="datetime-local" class="form-control" name="reserved_at" value="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                          ...
                          <li class="list-group-item list-group-item-success">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                  <br>
                                  <input type="submit" class="btn btn-success" name="confirm" value="Reserve Now">
                              </div>
