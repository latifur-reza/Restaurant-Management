...
@section('content')
  ...
  <div class="container-fluid ">
    <h1 class="text-center" style="color: black">Fixed Costs List Archive</h1>
  </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form class="" action="{!! route('fixedcostsdestroy',$item->id) !!}" method="post" enctype="multipart/form-data">
                        @csrf
              ...
              <div class="modal fade" id="active{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                      <form class="" action="{!! route('fixedcostsactive',$item->id) !!}" method="post" enctype="multipart/form-data">
                        @csrf
